...
## ShuaiQi's Project
## Date 	03-28-2016
## Aim: 	Try Baysesian on whold dataset LASSO
## @ authors: 	SQ
...
###############################################
## fit data to model
fitlasso<-stan(model_code=hiernormalLASSO, data=M1_table,iter=100000,warmup=90000,chains=4)

print(fitlasso)  		## Print fitlasso

answerlasso<-extract(fitlasso,permuted=TRUE)

print(answerlasso) #print samples 