...
## ShuaiQi's Project
## Date 	03-28-2016
## Aim: 	Try Baysesian on whold dataset
## @ authors: 	SQ
...
##################################################################
## fit data to stan model and extract sampling 
##################################################################


fitinv<-stan(model_code=hiernormalinvg, data=M1_table,iter=100000,warmup=90000,chains=4)      #10,000 samplings 

print(fitinv)              ## Print fitinv


answerinvergamma<-extract(fitinv,permuted=TRUE)   #get the samples 

print(answerinvergamma)    ## print samples
